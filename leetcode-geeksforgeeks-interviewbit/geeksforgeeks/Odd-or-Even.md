...
keywords: ["GeeksforGeeks", "GeeksforGeeks solution in Python3 C++ Java", "Odd Or Even Solution Explained"]
cover:
    image: https://res.cloudinary.com/samirpaul/image/upload/w_1100,c_fit,co_rgb:FFFFFF,l_text:Arial_75_bold:Odd Or Even - Solution Explained/problem-solving.webp
    alt: Odd Or Even
    hiddenInList: true
