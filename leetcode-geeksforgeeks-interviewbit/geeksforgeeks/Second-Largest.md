...
aliases: ["/posts/Second-Largest", "/blog/posts/Second-Largest", "/Second-Largest", "/blog/Second-Largest",]
keywords: GeeksforGeeks, GeeksforGeeks solution in Python3 C++ Java, Second Largest solution
cover:
    image: https://res.cloudinary.com/samirpaul/image/upload/w_1100,c_fit,co_rgb:FFFFFF,l_text:Arial_70_bold:Second Largest - Solution Explained/problem-solving.webp
    alt: Second Largest
    hiddenInList: true
