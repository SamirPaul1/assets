...
keywords: ["GeeksforGeeks", "GeeksforGeeks solution in Python3 C++ Java", "Vowel Or Not Solution Explained"]
cover:
    image: https://res.cloudinary.com/samirpaul/image/upload/w_1100,c_fit,co_rgb:FFFFFF,l_text:Arial_75_bold:Vowel Or Not - Solution Explained/problem-solving.webp
    alt: Vowel Or Not
    hiddenInList: true
