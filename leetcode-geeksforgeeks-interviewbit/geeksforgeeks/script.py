...
def make_md_file(folder_name):
  ...
  md_file.write(f"aliases: [\"/posts/{parmalink}\", \"/blog/posts/{parmalink}\", \"/{parmalink}\", \"/blog/{parmalink}\",]\n")
  md_file.write(f"keywords: GeeksforGeeks, GeeksforGeeks solution in Python3 C++ Java, {title_name} solution\n")
  md_file.write("cover:\n")
  md_file.write(f"    image: https://res.cloudinary.com/samirpaul/image/upload/w_1100,c_fit,co_rgb:FFFFFF,l_text:Arial_70_bold:{title_name} - Solution Explained/problem-solving.webp\n")
