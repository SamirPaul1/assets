...
aliases: ["/posts/tiling-problem", "/blog/posts/tiling-problem", "/tiling-problem"]
cover:
    image: https://res.cloudinary.com/samirpaul/image/upload/w_1100,c_fit,co_rgb:FFFFFF,l_text:Arial_70_bold:Tiling Problem - Solution Explained/problem-solving.webp
    alt: Tiling Problem
    hiddenInList: true
