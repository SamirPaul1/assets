...
tags: [leetcode]
series: [leetcode]
aliases: ["/posts/23-merge-k-sorted-lists", "/blog/posts/23-merge-k-sorted-lists", "/23-merge-k-sorted-lists"]
keywords: LeetCode, leetcode solution in Python3 C++ Java, 23-merge-k-sorted-lists solution
cover:
    image: https://res.cloudinary.com/samirpaul/image/upload/w_1100,c_fit,co_rgb:FFFFFF,l_text:Arial_70_bold:23 Merge K Sorted Lists/problem-solving.webp
