...
summary: Check if a String Is an Acronym of Words - Solution Explained
url: "/posts/check-if-a-string-is-an-acronym-of-words"
date: 2020-07-30T04:00:00
tags: ["leetcode", "problem-solving"]
series: [leetcode]
keywords: ["Check if a String Is an Acronym of Words LeetCode Solution Explained in all languages", "2828", "leetcode question 2828", "Check if a String Is an Acronym of Words", "LeetCode", "leetcode solution in Python3 C++ Java Go PHP Ruby Swift TypeScript Rust C# JavaScript C", "GeeksforGeeks", "InterviewBit", "Coding Ninjas", "HackerRank", "HackerEarth", "CodeChef", "TopCoder", "AlgoExpert", "freeCodeCamp", "Codeforces", "GitHub", "AtCoder", "Samir Paul"]
cover:
    image: https://spcdn.pages.dev/leetcode/images/check-if-a-string-is-an-acronym-of-words.webp
    alt: Check if a String Is an Acronym of Words - Solution Explained
    hiddenInList: true
