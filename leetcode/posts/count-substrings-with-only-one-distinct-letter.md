...
summary: Count Substrings with Only One Distinct Letter - Solution Explained
url: "/posts/count-substrings-with-only-one-distinct-letter"
date: 2020-10-06T20:00:00
tags: ["leetcode", "problem-solving"]
series: [leetcode]
keywords: ["Count Substrings with Only One Distinct Letter LeetCode Solution Explained in all languages", "1180", "leetcode question 1180", "Count Substrings with Only One Distinct Letter", "LeetCode", "leetcode solution in Python3 C++ Java Go PHP Ruby Swift TypeScript Rust C# JavaScript C", "GeeksforGeeks", "InterviewBit", "Coding Ninjas", "HackerRank", "HackerEarth", "CodeChef", "TopCoder", "AlgoExpert", "freeCodeCamp", "Codeforces", "GitHub", "AtCoder", "Samir Paul"]
cover:
    image: https://spcdn.pages.dev/leetcode/images/count-substrings-with-only-one-distinct-letter.webp
    alt: Count Substrings with Only One Distinct Letter - Solution Explained
    hiddenInList: true
