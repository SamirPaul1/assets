...
summary: Longest ZigZag Path in a Binary Tree - Solution Explained
url: "/posts/longest-zigzag-path-in-a-binary-tree"
date: 2020-09-28T20:00:00
tags: ["leetcode", "problem-solving"]
series: [leetcode]
keywords: ["Longest ZigZag Path in a Binary Tree LeetCode Solution Explained in all languages", "1372", "leetcode question 1372", "Longest ZigZag Path in a Binary Tree", "LeetCode", "leetcode solution in Python3 C++ Java Go PHP Ruby Swift TypeScript Rust C# JavaScript C", "GeeksforGeeks", "InterviewBit", "Coding Ninjas", "HackerRank", "HackerEarth", "CodeChef", "TopCoder", "AlgoExpert", "freeCodeCamp", "Codeforces", "GitHub", "AtCoder", "Samir Paul"]
cover:
    image: https://spcdn.pages.dev/leetcode/images/longest-zigzag-path-in-a-binary-tree.webp
    alt: Longest ZigZag Path in a Binary Tree - Solution Explained
    hiddenInList: true
