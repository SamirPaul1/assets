...
summary: Maximize Distance to Closest Person - Solution Explained
url: "/posts/maximize-distance-to-closest-person"
date: 2020-10-20T15:00:00
tags: ["leetcode", "problem-solving"]
series: [leetcode]
keywords: ["Maximize Distance to Closest Person LeetCode Solution Explained in all languages", "849", "leetcode question 849", "Maximize Distance to Closest Person", "LeetCode", "leetcode solution in Python3 C++ Java Go PHP Ruby Swift TypeScript Rust C# JavaScript C", "GeeksforGeeks", "InterviewBit", "Coding Ninjas", "HackerRank", "HackerEarth", "CodeChef", "TopCoder", "AlgoExpert", "freeCodeCamp", "Codeforces", "GitHub", "AtCoder", "Samir Paul"]
cover:
    image: https://spcdn.pages.dev/leetcode/images/maximize-distance-to-closest-person.webp
    alt: Maximize Distance to Closest Person - Solution Explained
    hiddenInList: true
