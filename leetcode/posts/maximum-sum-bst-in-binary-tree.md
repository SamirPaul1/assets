...
summary: Maximum Sum BST in Binary Tree - Solution Explained
url: "/posts/maximum-sum-bst-in-binary-tree"
date: 2020-09-28T19:00:00
tags: ["leetcode", "problem-solving"]
series: [leetcode]
keywords: ["Maximum Sum BST in Binary Tree LeetCode Solution Explained in all languages", "1373", "leetcode question 1373", "Maximum Sum BST in Binary Tree", "LeetCode", "leetcode solution in Python3 C++ Java Go PHP Ruby Swift TypeScript Rust C# JavaScript C", "GeeksforGeeks", "InterviewBit", "Coding Ninjas", "HackerRank", "HackerEarth", "CodeChef", "TopCoder", "AlgoExpert", "freeCodeCamp", "Codeforces", "GitHub", "AtCoder", "Samir Paul"]
cover:
    image: https://spcdn.pages.dev/leetcode/images/maximum-sum-bst-in-binary-tree.webp
    alt: Maximum Sum BST in Binary Tree - Solution Explained
    hiddenInList: true
