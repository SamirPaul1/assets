...
summary: Minimum Distance to Type a Word Using Two Fingers - Solution Explained
url: "/posts/minimum-distance-to-type-a-word-using-two-fingers"
date: 2020-10-01T00:00:00
tags: ["leetcode", "problem-solving"]
series: [leetcode]
keywords: ["Minimum Distance to Type a Word Using Two Fingers LeetCode Solution Explained in all languages", "1320", "leetcode question 1320", "Minimum Distance to Type a Word Using Two Fingers", "LeetCode", "leetcode solution in Python3 C++ Java Go PHP Ruby Swift TypeScript Rust C# JavaScript C", "GeeksforGeeks", "InterviewBit", "Coding Ninjas", "HackerRank", "HackerEarth", "CodeChef", "TopCoder", "AlgoExpert", "freeCodeCamp", "Codeforces", "GitHub", "AtCoder", "Samir Paul"]
cover:
    image: https://spcdn.pages.dev/leetcode/images/minimum-distance-to-type-a-word-using-two-fingers.webp
    alt: Minimum Distance to Type a Word Using Two Fingers - Solution Explained
    hiddenInList: true
