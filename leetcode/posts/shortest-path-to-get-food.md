...
summary: Shortest Path to Get Food - Solution Explained
url: "/posts/shortest-path-to-get-food"
date: 2020-09-13T22:00:00
tags: ["leetcode", "problem-solving"]
series: [leetcode]
keywords: ["Shortest Path to Get Food LeetCode Solution Explained in all languages", "1730", "leetcode question 1730", "Shortest Path to Get Food", "LeetCode", "leetcode solution in Python3 C++ Java Go PHP Ruby Swift TypeScript Rust C# JavaScript C", "GeeksforGeeks", "InterviewBit", "Coding Ninjas", "HackerRank", "HackerEarth", "CodeChef", "TopCoder", "AlgoExpert", "freeCodeCamp", "Codeforces", "GitHub", "AtCoder", "Samir Paul"]
cover:
    image: https://spcdn.pages.dev/leetcode/images/shortest-path-to-get-food.webp
    alt: Shortest Path to Get Food - Solution Explained
    hiddenInList: true
