...
summary: Shortest Path with Alternating Colors - Solution Explained
url: "/posts/shortest-path-with-alternating-colors"
date: 2020-10-08T23:00:00
tags: ["leetcode", "problem-solving"]
series: [leetcode]
keywords: ["Shortest Path with Alternating Colors LeetCode Solution Explained in all languages", "1129", "leetcode question 1129", "Shortest Path with Alternating Colors", "LeetCode", "leetcode solution in Python3 C++ Java Go PHP Ruby Swift TypeScript Rust C# JavaScript C", "GeeksforGeeks", "InterviewBit", "Coding Ninjas", "HackerRank", "HackerEarth", "CodeChef", "TopCoder", "AlgoExpert", "freeCodeCamp", "Codeforces", "GitHub", "AtCoder", "Samir Paul"]
cover:
    image: https://spcdn.pages.dev/leetcode/images/shortest-path-with-alternating-colors.webp
    alt: Shortest Path with Alternating Colors - Solution Explained
    hiddenInList: true
