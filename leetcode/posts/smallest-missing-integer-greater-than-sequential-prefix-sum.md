...
summary: Smallest Missing Integer Greater Than Sequential Prefix Sum - Solution Explained
url: "/posts/smallest-missing-integer-greater-than-sequential-prefix-sum"
date: 2020-07-23T04:00:00
tags: ["leetcode", "problem-solving"]
series: [leetcode]
keywords: ["Smallest Missing Integer Greater Than Sequential Prefix Sum LeetCode Solution Explained in all languages", "2996", "leetcode question 2996", "Smallest Missing Integer Greater Than Sequential Prefix Sum", "LeetCode", "leetcode solution in Python3 C++ Java Go PHP Ruby Swift TypeScript Rust C# JavaScript C", "GeeksforGeeks", "InterviewBit", "Coding Ninjas", "HackerRank", "HackerEarth", "CodeChef", "TopCoder", "AlgoExpert", "freeCodeCamp", "Codeforces", "GitHub", "AtCoder", "Samir Paul"]
cover:
    image: https://spcdn.pages.dev/leetcode/images/smallest-missing-integer-greater-than-sequential-prefix-sum.webp
    alt: Smallest Missing Integer Greater Than Sequential Prefix Sum - Solution Explained
    hiddenInList: true
