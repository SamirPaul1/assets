---
title: Sqrt(x)
summary: Sqrt(x) - Solution Explained
url: "/posts/sqrtx"
date: 2020-11-22T03:00:00
tags: ["leetcode", "problem-solving"]
series: [leetcode]
keywords: ["Sqrt(x) LeetCode Solution Explained in all languages", "69", "leetcode question 69", "Sqrt(x)", "LeetCode", "leetcode solution in Python3 C++ Java Go PHP Ruby Swift TypeScript Rust C# JavaScript C", "GeeksforGeeks", "InterviewBit", "Coding Ninjas", "HackerRank", "HackerEarth", "CodeChef", "TopCoder", "AlgoExpert", "freeCodeCamp", "Codeforces", "GitHub", "AtCoder", "Samir Paul"]
cover:
    image: https://spcdn.pages.dev/leetcode/images/sqrtx.webp
    alt: Sqrt(x) - Solution Explained
    hiddenInList: true
