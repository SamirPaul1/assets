...
summary: Two Furthest Houses With Different Colors - Solution Explained
url: "/posts/two-furthest-houses-with-different-colors"
date: 2020-08-30T10:00:00
tags: ["leetcode", "problem-solving"]
series: [leetcode]
keywords: ["Two Furthest Houses With Different Colors LeetCode Solution Explained in all languages", "2078", "leetcode question 2078", "Two Furthest Houses With Different Colors", "LeetCode", "leetcode solution in Python3 C++ Java Go PHP Ruby Swift TypeScript Rust C# JavaScript C", "GeeksforGeeks", "InterviewBit", "Coding Ninjas", "HackerRank", "HackerEarth", "CodeChef", "TopCoder", "AlgoExpert", "freeCodeCamp", "Codeforces", "GitHub", "AtCoder", "Samir Paul"]
cover:
    image: https://spcdn.pages.dev/leetcode/images/two-furthest-houses-with-different-colors.webp
    alt: Two Furthest Houses With Different Colors - Solution Explained
    hiddenInList: true
